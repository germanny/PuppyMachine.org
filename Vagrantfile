Vagrant.configure("2") do |config|
  ...
  config.vm.define :local do |box|
    box.vm.hostname = "local.puppymachine.org"

    # Static IP for testing.
    box.vm.network :private_network, ip: "192.168.85.169"
    box.vm.network :forwarded_port, guest: 22, host: 5169, auto_correct: true
    ...
    # Provision local.puppymachine.org
